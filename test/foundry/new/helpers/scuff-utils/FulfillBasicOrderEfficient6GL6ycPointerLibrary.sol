...
library FulfillBasicOrderEfficient6GL6ycPointerLibrary {
  ...
  function fromArgs(BasicOrderParameters memory parameters) internal pure returns (FulfillBasicOrderEfficient6GL6ycPointer ptrOut) {
    bytes memory data = abi.encodeWithSignature("fulfillBasicOrder_efficient_6GL6yc((address,uint256,uint256,address,address,address,uint256,uint256,uint8,uint256,uint256,bytes32,uint256,bytes32,bytes32,uint256,(uint256,address)[],bytes))", parameters);
