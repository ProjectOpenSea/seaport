...
library DynArrayOrderComponentsPointerLibrary {
  ...
  function toString(ScuffKind k) internal pure returns (string memory) {
    ...
    if (k == ScuffKind.element_consideration_element_token_MaxValue) return "element_consideration_element_token_MaxValue";
    ...
    if (k == ScuffKind.element_consideration_element_recipient_MaxValue) return "element_consideration_element_recipient_MaxValue";
