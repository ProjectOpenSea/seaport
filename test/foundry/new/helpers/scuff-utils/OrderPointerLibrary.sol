...
library OrderPointerLibrary {
    enum ScuffKind {
        ...
        parameters_offerer_MaxValue,
        parameters_zone_DirtyBits,
        parameters_zone_MaxValue,
        parameters_offer_head_DirtyBits,
        parameters_offer_head_MaxValue,
        parameters_offer_length_DirtyBits,
        parameters_offer_length_MaxValue,
        ...
        parameters_offer_element_token_MaxValue,
        parameters_consideration_head_DirtyBits,
        parameters_consideration_head_MaxValue,
        parameters_consideration_length_DirtyBits,
        parameters_consideration_length_MaxValue,
        ...
        parameters_consideration_element_token_MaxValue,
        parameters_consideration_element_recipient_DirtyBits,
        parameters_consideration_element_recipient_MaxValue,
        parameters_orderType_DirtyBits,
        parameters_orderType_MaxValue,
        signature_head_DirtyBits,
        signature_head_MaxValue,
        signature_length_DirtyBits,
        signature_length_MaxValue,
    ...
    uint256 internal constant MinimumSignatureScuffKind =
        uint256(ScuffKind.signature_length_DirtyBits);
    ...
    function addScuffDirectives(
        ...
        directives.push(
            Scuff.upper(
                uint256(ScuffKind.signature_head_DirtyBits) + kindOffset,
                224,
                ptr.signatureHead(),
                positions
            )
        ...
        directives.push(
            Scuff.lower(
                uint256(ScuffKind.signature_head_MaxValue) + kindOffset,
                224,
                ptr.signatureHead(),
                positions
            )
    ...
    function toString(ScuffKind k) internal pure returns (string memory) {
        ...
        if (k == ScuffKind.parameters_offerer_MaxValue)
            return "parameters_offerer_MaxValue";
        if (k == ScuffKind.parameters_zone_DirtyBits)
            return "parameters_zone_DirtyBits";
        if (k == ScuffKind.parameters_zone_MaxValue)
            return "parameters_zone_MaxValue";
        if (k == ScuffKind.parameters_offer_head_DirtyBits)
            return "parameters_offer_head_DirtyBits";
        if (k == ScuffKind.parameters_offer_head_MaxValue)
            return "parameters_offer_head_MaxValue";
        if (k == ScuffKind.parameters_offer_length_DirtyBits)
            return "parameters_offer_length_DirtyBits";
        if (k == ScuffKind.parameters_offer_length_MaxValue)
            return "parameters_offer_length_MaxValue";
        ...
        if (k == ScuffKind.parameters_offer_element_token_MaxValue)
            return "parameters_offer_element_token_MaxValue";
        if (k == ScuffKind.parameters_consideration_head_DirtyBits)
            return "parameters_consideration_head_DirtyBits";
        if (k == ScuffKind.parameters_consideration_head_MaxValue)
            return "parameters_consideration_head_MaxValue";
        if (k == ScuffKind.parameters_consideration_length_DirtyBits)
            return "parameters_consideration_length_DirtyBits";
        if (k == ScuffKind.parameters_consideration_length_MaxValue)
            return "parameters_consideration_length_MaxValue";
        ...
        if (k == ScuffKind.parameters_consideration_element_token_MaxValue)
            return "parameters_consideration_element_token_MaxValue";
        ...
        if (k == ScuffKind.parameters_consideration_element_recipient_MaxValue)
            return "parameters_consideration_element_recipient_MaxValue";
        ...
        if (k == ScuffKind.signature_head_DirtyBits)
            return "signature_head_DirtyBits";
        if (k == ScuffKind.signature_head_MaxValue)
            return "signature_head_MaxValue";
        if (k == ScuffKind.signature_length_DirtyBits)
            return "signature_length_DirtyBits";
        if (k == ScuffKind.signature_length_MaxValue)
            return "signature_length_MaxValue";
