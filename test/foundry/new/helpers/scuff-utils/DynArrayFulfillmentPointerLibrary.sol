...
library DynArrayFulfillmentPointerLibrary {
    enum ScuffKind {
        ...
        element_offerComponents_head_DirtyBits,
        element_offerComponents_head_MaxValue,
        element_offerComponents_length_DirtyBits,
        element_offerComponents_length_MaxValue,
        element_considerationComponents_head_DirtyBits,
        element_considerationComponents_head_MaxValue,
        element_considerationComponents_length_DirtyBits,
        element_considerationComponents_length_MaxValue
    }
    ...
    uint256 internal constant MinimumElementScuffKind =
        uint256(ScuffKind.element_offerComponents_head_DirtyBits);
    uint256 internal constant MaximumElementScuffKind =
        uint256(ScuffKind.element_considerationComponents_length_MaxValue);
    ...
    function wrap(
        MemoryPointer ptr
    ) internal pure returns (DynArrayFulfillmentPointer) {
    ...
    function unwrap(
        DynArrayFulfillmentPointer ptr
    ...
    function elementData(
        DynArrayFulfillmentPointer ptr,
        uint256 index
    ) internal pure returns (FulfillmentPointer) {
        return
            FulfillmentPointerLibrary.wrap(
    ...
    function toString(ScuffKind k) internal pure returns (string memory) {
        ...
        if (k == ScuffKind.element_offerComponents_head_DirtyBits)
            return "element_offerComponents_head_DirtyBits";
        if (k == ScuffKind.element_offerComponents_head_MaxValue)
            return "element_offerComponents_head_MaxValue";
        if (k == ScuffKind.element_offerComponents_length_DirtyBits)
            return "element_offerComponents_length_DirtyBits";
        if (k == ScuffKind.element_offerComponents_length_MaxValue)
            return "element_offerComponents_length_MaxValue";
        if (k == ScuffKind.element_considerationComponents_head_DirtyBits)
            return "element_considerationComponents_head_DirtyBits";
        if (k == ScuffKind.element_considerationComponents_head_MaxValue)
            return "element_considerationComponents_head_MaxValue";
        if (k == ScuffKind.element_considerationComponents_length_DirtyBits)
            return "element_considerationComponents_length_DirtyBits";
