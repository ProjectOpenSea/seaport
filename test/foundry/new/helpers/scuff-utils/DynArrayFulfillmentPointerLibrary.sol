...
library DynArrayFulfillmentPointerLibrary {
  enum ScuffKind { length_DirtyBits, element_head_DirtyBits, element_head_MaxValue, element_offerComponents_head_DirtyBits, element_offerComponents_head_MaxValue, element_offerComponents_length_DirtyBits, element_considerationComponents_head_DirtyBits, element_considerationComponents_head_MaxValue, element_considerationComponents_length_DirtyBits }
  ...
  uint256 internal constant MaximumElementScuffKind = uint256(ScuffKind.element_considerationComponents_length_DirtyBits);
