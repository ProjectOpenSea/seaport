...
library FulfillAdvancedOrderPointerLibrary {
  enum ScuffKind { advancedOrder_parameters_offerer_DirtyBits, advancedOrder_parameters_zone_DirtyBits, advancedOrder_parameters_offer_element_itemType_DirtyBits, advancedOrder_parameters_offer_element_itemType_MaxValue, advancedOrder_parameters_offer_element_token_DirtyBits, advancedOrder_parameters_consideration_element_itemType_DirtyBits, advancedOrder_parameters_consideration_element_itemType_MaxValue, advancedOrder_parameters_consideration_element_token_DirtyBits, advancedOrder_parameters_consideration_element_recipient_DirtyBits, advancedOrder_parameters_orderType_DirtyBits, advancedOrder_parameters_orderType_MaxValue, advancedOrder_numerator_DirtyBits, advancedOrder_denominator_DirtyBits, criteriaResolvers_element_side_DirtyBits, criteriaResolvers_element_side_MaxValue, recipient_DirtyBits }
  ...
  uint256 internal constant MinimumAdvancedOrderScuffKind = uint256(ScuffKind.advancedOrder_parameters_offerer_DirtyBits);
  uint256 internal constant MaximumAdvancedOrderScuffKind = uint256(ScuffKind.advancedOrder_denominator_DirtyBits);
