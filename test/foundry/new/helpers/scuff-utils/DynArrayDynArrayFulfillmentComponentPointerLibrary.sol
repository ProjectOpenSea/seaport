...
library DynArrayDynArrayFulfillmentComponentPointerLibrary {
  enum ScuffKind { length_DirtyBits, element_head_DirtyBits, element_head_MaxValue, element_length_DirtyBits }
  ...
  uint256 internal constant MaximumElementScuffKind = uint256(ScuffKind.element_length_DirtyBits);
  ...
  function toString(ScuffKind k) internal pure returns (string memory) {
    ...
    return "element_length_DirtyBits";
  }
