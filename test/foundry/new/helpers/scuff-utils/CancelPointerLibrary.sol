...
library CancelPointerLibrary {
  enum ScuffKind { orders_element_offerer_DirtyBits, orders_element_zone_DirtyBits, orders_element_offer_element_itemType_DirtyBits, orders_element_offer_element_itemType_MaxValue, orders_element_offer_element_token_DirtyBits, orders_element_consideration_element_itemType_DirtyBits, orders_element_consideration_element_itemType_MaxValue, orders_element_consideration_element_token_DirtyBits, orders_element_consideration_element_recipient_DirtyBits, orders_element_orderType_DirtyBits, orders_element_orderType_MaxValue }
  ...
  uint256 internal constant MinimumOrdersScuffKind = uint256(ScuffKind.orders_element_offerer_DirtyBits);
