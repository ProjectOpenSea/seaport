...
library BasicOrderParametersPointerLibrary {
    enum ScuffKind {
        basicOrderType_MaxValue,
        additionalRecipients_head_DirtyBits,
        additionalRecipients_head_MaxValue,
        additionalRecipients_length_DirtyBits,
        additionalRecipients_length_MaxValue,
        additionalRecipients_element_recipient_DirtyBits,
    ...
    uint256 internal constant MinimumAdditionalRecipientsScuffKind =
        uint256(ScuffKind.additionalRecipients_length_DirtyBits);
    uint256 internal constant MaximumAdditionalRecipientsScuffKind =
        uint256(ScuffKind.additionalRecipients_element_recipient_DirtyBits);
    ...
    function unwrap(
        BasicOrderParametersPointer ptr
    ...
    /// This points to the beginning of the encoded `uint256`
    function totalOriginalAdditionalRecipients(
        BasicOrderParametersPointer ptr
    ) internal pure returns (MemoryPointer) {
    ...
    function additionalRecipientsHead(
        BasicOrderParametersPointer ptr
    ) internal pure returns (MemoryPointer) {
    ...
    function additionalRecipientsData(
        BasicOrderParametersPointer ptr
    ) internal pure returns (DynArrayAdditionalRecipientPointer) {
        return
            DynArrayAdditionalRecipientPointerLibrary.wrap(
                ptr.unwrap().offset(additionalRecipientsHead(ptr).readUint256())
            );
    }
    ...
    function addScuffDirectives(
        ...
        directives.push(
            Scuff.lower(
                uint256(ScuffKind.basicOrderType_MaxValue) + kindOffset,
                251,
                ptr.basicOrderType(),
                positions
            )
        ...
        directives.push(
            Scuff.upper(
                uint256(ScuffKind.additionalRecipients_head_DirtyBits) +
                    kindOffset,
                224,
                ptr.additionalRecipientsHead(),
                positions
            )
        );
        ...
        directives.push(
            Scuff.lower(
                uint256(ScuffKind.additionalRecipients_head_MaxValue) +
                    kindOffset,
                229,
                ptr.additionalRecipientsHead(),
                positions
        ...
        ptr.additionalRecipientsData().addScuffDirectives(
            directives,
            kindOffset + MinimumAdditionalRecipientsScuffKind,
            positions
        );
    ...
    function toString(ScuffKind k) internal pure returns (string memory) {
        if (k == ScuffKind.basicOrderType_MaxValue)
            return "basicOrderType_MaxValue";
        if (k == ScuffKind.additionalRecipients_head_DirtyBits)
            return "additionalRecipients_head_DirtyBits";
        if (k == ScuffKind.additionalRecipients_head_MaxValue)
            return "additionalRecipients_head_MaxValue";
        if (k == ScuffKind.additionalRecipients_length_DirtyBits)
            return "additionalRecipients_length_DirtyBits";
        if (k == ScuffKind.additionalRecipients_length_MaxValue)
            return "additionalRecipients_length_MaxValue";
        if (k == ScuffKind.additionalRecipients_element_recipient_DirtyBits)
            return "additionalRecipients_element_recipient_DirtyBits";
