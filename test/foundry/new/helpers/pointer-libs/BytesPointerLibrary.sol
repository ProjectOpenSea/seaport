...
library BytesPointerLibrary {
  enum ScuffKind { LengthOverflow, DirtyLowerBits }
  ...
  function addScuffDirectives(BytesPointer ptr, ScuffDirectivesArray directives, uint256 kindOffset) internal pure {
    /// @dev Overflow length of bytes
