...
contract FuzzEngineTest is FuzzEngine {
    ...
    function xtest_check_contractOrderExpectedDataHashes() public {
...

        {
            ...
            context
                .expectations.expectedContractOrderCalldataHashes = expectedContractOrderCalldataHashes;
    ...
    function check_revertWithContextData(
        ...
        revert ExampleErrorWithContextData(context.executionState.orders[0].signature);
    }
